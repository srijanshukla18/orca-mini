...
Signed and notarized builds will be published on the [Releases](https://github.com/srijanshukla18/browser/releases) page. Release artifacts are Apple-silicon-only DMGs named `Orca-Mini-<version>-arm64.dmg`.
